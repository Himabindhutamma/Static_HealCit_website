          ...
          const getstaticData = () => {
            Axios.getData(`SelectAll_staticPages/`)
              .then(res => {
                console.log(res)
                let r = res
                var newdata = r.find(i => i['name_staticPages'] === 'dcont1')
                ...
                let r1 = res
                var newdata1 = r1.find(i => i['name_staticPages'] === 'dservice1')
                ...
                let r2 = res
                var newdata2 = r2.find(i => i['name_staticPages'] === 'dbannerdata1')
          ...
          <div class="article">
            <div class="departments-3__single">
              ...
              <ul class="lists">
                ...
                <li class="list-item">
                  <i class="fa fa-check"></i>{staticcarddata.parap4}
                </li>
                <li class="list-item">
                  <i class="fa fa-check"></i>{staticcarddata.parap5}
                </li>
                <li class="list-item">
                  <i class="fa fa-check"></i>{staticcarddata.parap6}
                </li>
                <li class="list-item">
                  <i class="fa fa-check"></i>{staticcarddata.parap7}
                </li>
              </ul>
              <h3>{staticcarddata.subpara}</h3>
              <div class="prices">
