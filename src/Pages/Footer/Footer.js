        ...
        <>
            ...
            <div class="footer__top">
                {/* <div class="footer__logo">
                    <img src="./Assets/images/logorcht.png" alt="footer-logo"/>
                </div> */}
                <div class="container">
                    <div>
                                ...
                                <div class="content-item">
                                    <div class="icon">
                                        <svg width="24.375" height="24.343" viewBox="0 0 24.375 24.343">
                                            <path id="phone.svg" class="header-top__call-icon cls-6"
                                ...
                                <div class="content-item">
                                    <div class="icon">
                                        <svg width="18.88" height="25.719" viewBox="0 0 18.88 25.719">
                                            <path id="address.svg" class="header-top__call-icon cls-6"
                                    ...
                                    <div class="text">
                                        ...
                                        <a href="https://www.google.com/maps/dir//Pyramid+-+SRI+SHIVARATNAPURI+TEMPLE+OF+HEALTH+Kenchenhalli,+RR+Nagar+Bengaluru,+Karnataka+560098/@12.9270287,77.5118933,14z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3bae3ef9a8b779ed:0xeb0d29de805134f1!2m2!1d77.5118933!2d12.9270287"target="_blank" class="location">Get directions on the map <i
                                ...
                                <div class="content-item">
                                    <div class="icon">
                                        <svg width="25.16" height="25.157" viewBox="0 0 25.16 25.157">
                                            <path id="envelope.svg" class="header-top__call-icon cls-6"
                                    ...
                                    <div class="text">
                                        <a href="mailto:info@healcit.com">info@healcit.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        <div class="footer__top-blocks">
                            ...
                            <div class="content">
                                ...
                                <div class="socials">
                                    <a href="https://www.facebook.com/people/Healcitindia/100083371200925/?paipv=0&eav=AfbYyDi9mM7jQmUcPm1mreGPEpY0DKweOIwk034Ri5P0c8SOnRAl-wNNXhpUcpAUS5w" target="_blank" title="facebook"><i className="fa fa-facebook"></i></a>
                                    <a href="https://twitter.com/healcit_india" target="_blank" title="twitter"><i className="fa fa-twitter"></i></a>
                                    <a href="https://www.instagram.com/healcitindia/?igshid=YmMyMTA2M2Y%3D" target="_blank" title="instagram"><i className="fa fa-instagram"></i></a>
                                    <a href="https://www.linkedin.com/company/healcitindia-pvt-ltd/" target="_blank" title="linkedin"><i className="fa-brands fa-linkedin-in"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="footer__top-blocks">
                            ...
                            <div class="content">
                                <ul class="menu">
                                    ...
                                    {/* <li>
                                        <a href="#Ourspecialist"><i class="fa fa-angle-right"></i>Doctors</a>
                                    </li> */}
                                    <li>
                                ...
                                <Link to={{ pathname: "https://example.zendesk.com/hc/en-us/articles/123456789-Privacy-Policies" }} target="_blank"></Link>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer__bottom">
                <p>Copyright &copy; 2022  NTLIFE CARE | Privacy Policy</p>
            </div>
