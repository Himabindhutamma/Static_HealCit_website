            ...
            <div className="container">
                ...
                <div className="header-top__call">
                    ...
                    <div className="header-top__call-item">
                        ...
                        <div className="header-top__call-text">
                            <p>Visiting Hours: 09:00am - 04:00pm</p>
                    ...
                    >Log Out</Button>
                    : <Button to='/login' onClick={()=>navigate('/login')} className="logout">Log In</Button>
                }
                   
                </div>
            </div>
        </header>
        <header className="header-middle header-middle_white-transparent" id="sticky-header" ref={stickyHeader}>
            <div className="container">
                ...
                <div className="navbar-icon" onClick={menuOnClickHandler}>
                    <span></span>
                </div>
                <div className={`navbar ${showMenu?'show':'hide'}`}>

                    <ul className="navbar__menu">
                        <li className="navbar__menu-item">
                        <Link className="navbar__menu-link" to="/home" onClick={()=>setShowMenu(false)}> HOME</Link>
                        </li>
                    <li className="navbar__menu-item">
                        <Link className="navbar__menu-link" to="/searchdoctor" onClick={()=>setShowMenu(false)}> DOCTORS</Link>
                        </li>
                        <li className="navbar__menu-item">
                        <Link className="navbar__menu-link" to="/clinic"onClick={()=>setShowMenu(false)}> CLINIC</Link>
                        </li>
                        <li className="navbar__menu-item">
                        <Link className="navbar__menu-link" to="/hospital"onClick={()=>setShowMenu(false)}> HOSPITAL</Link>
                        </li>

                        {/* <li className="navbar__menu-item">
                        <Link className="navbar__menu-link " to="/services"onClick={()=>setShowMenu(false)}> EVENTS</Link>
                            
                        </li> */}

                        <li className="navbar__menu-item">
                        <Link className="navbar__menu-link " to="/aboutus" onClick={()=>setShowMenu(false)}> ABOUT US</Link>
                          
                        </li>

                        <li className="navbar__menu-item">
                        <Link className="navbar__menu-link " to="/contactus" onClick={()=>setShowMenu(false)}> CONTACT US</Link>
                    ...
                    <div className="navbar__right">
                        {isLogin &&
                         <Link className="btn btn_pink"to="/dashboard/profile"  id="popup-form-open" onClick={()=>setShowMenu(false)}> MAKE AN APPOINTMENT</Link>
                        }
                    </div>
                </div>
