      ...
      const getstaticData = () => {
        Axios.getData(`SelectAll_staticPages/`)
          .then(res => {
            console.log(res)
            let r = res
            var newdata = r.find(i => i['name_staticPages'] === 'WhyChooseUs')
    ...
    return(
        <>
            ...
            <div class="why-choose-us__bg">
                ...
                {/* <img src="./Assets/images/png/nurse.png" alt=""/> */}
                <img src={img} alt="icons" />
            </div>
            <div class="container">
                <h5>{staticcarddata.subheading}</h5>
                ...
                <div class="difference">
                    ...
                    <div class="difference__item wow fadeInLeft" data-wow-duration="1s">
                        <h1 class="difference__item-number">{staticcarddata.number}</h1>
                        <div class="difference__item-content">
                            <h1 class="difference__item-title">{staticcarddata.heading}</h1>
                            <p class="difference__item-text">{staticcarddata.para}</p>
                        </div>
                    </div>

                    <div class="difference__item wow fadeInLeft" data-wow-duration="1s">
                        <h1 class="difference__item-number">{staticcarddata.number1}</h1>
                        <div class="difference__item-content">
                            <h1 class="difference__item-title">{staticcarddata.heading1}</h1>
                            <p class="difference__item-text">{staticcarddata.para1}</p>
                        </div>
                    </div>

                    <div class="difference__item wow fadeInLeft" data-wow-duration="1s">
                        <h1 class="difference__item-number">{staticcarddata.number2}</h1>
                        <div class="difference__item-content">
                            <h1 class="difference__item-title">{staticcarddata.heading2}</h1>
                            <p class="difference__item-text">{staticcarddata.para2}</p>
                        </div>
                    </div>

                    <div class="difference__item wow fadeInLeft" data-wow-duration="1s">
                        <h1 class="difference__item-number">{staticcarddata.number3}</h1>
                        <div class="difference__item-content">
                            <h1 class="difference__item-title">{staticcarddata.heading3}</h1>
                            <p class="difference__item-text">{staticcarddata.para}</p>
                        </div>
                    </div>
