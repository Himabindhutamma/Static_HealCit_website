    ...
    const getstaticData = () => {
      Axios.getData(`SelectAll_staticPages/`)
        .then(res => {
          ...
          let r = res
          var newdata = r.find(i => i['name_staticPages'] === 'WhoWeAre-1')
          ...
          <div class="container">
              <div class="about__our-misson wow fadeInLeft" data-wow-duration="1s">
                  ...
                  <div class="about__our-misson-text">
                      ...
                      <p class="text">It is the first hospital day care Center in the world in the form of a pyramid, offering multiple systems of medicine.
                      </p>
                  </div>
              ...
              <div class="about__text wow fadeInRight" data-wow-duration="1s">
                  ...
                  {/* {/ <h1 class="section-title"> Sri Shivaratnapuri <br/><span>Temple of Health</span> </h1> /} */}
